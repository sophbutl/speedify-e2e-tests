...
from helpers.ui_helpers import ONOFF, STATUS_TEXT, TOGGLE, goto_dashboard
...
# Verify a very small viewport does not crash the page or lose key elements from the DOM
...
# Verify a very large viewport renders all major sections without horizontal overflow
...
# Verify resizing the viewport while scrolled to the bottom does not lose content
...
# Verify connect/disconnect still works correctly after resizing from a small to a large viewport
